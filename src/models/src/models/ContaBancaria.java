...
public abstract class ContaBancaria {
    private long numeroDaConta;  // Alterado para long, evitando o cast
    private String titular;
    private double saldo;
    private String tipoDeConta;

    public ContaBancaria(long numeroDaConta, String titular, double saldo, String tipoDeConta) {
        this.numeroDaConta = numeroDaConta;  // Agora não há cast
        this.titular = titular;
        this.saldo = saldo;
        this.tipoDeConta = tipoDeConta;
    }

    public long getNumeroDaConta() {  // Alterado para long
    ...
    public void depositar(double valor) {
        this.saldo += valor;  // Corrigido para somar o valor ao saldo
    }
